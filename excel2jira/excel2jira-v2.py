    ...
    for idx, row in df.iterrows():
        ...
        try:
            if issue_type and issue_type.lower() == 'epic':
                ...
                epic_fields['project'] = {'key': QBV_PROJECT_KEY}
                epic_fields['issuetype'] = {'id': '10222'}
                issue = jira.create_issue(fields=epic_fields)
                ...
                # Create a story under the specified epic
                story_fields = epic_fields.copy()
                story_fields['issuetype'] = {'name': 'Story'}
                story_fields['parent'] = {'key': 'ITDVPS-976'}
                
                # Remove Epic-specific fields
                for field in [YEAR_FIELD_ID, QUARTER_FIELD_ID, IN_QUARTER_PLAN_FIELD_ID]:
                    story_fields.pop(field, None)
